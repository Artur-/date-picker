...
/**
 * Connector for &lt;vaadin-combo-box&gt;, exists mainly to be able to define
 * the root element tag.
 */
@Connect(ComboBox.class)
public class ComboBoxDummyConnector extends AbstractComponentConnector
    ...
    @Override
    public FakeVaadinComboBox getWidget() {
        return (FakeVaadinComboBox) super.getWidget();
    }
